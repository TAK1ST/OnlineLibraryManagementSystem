 ...
 * @author CAU_TU
 */
public class RegisterHashPasswordFilter implements Filter {
    ...
    public RegisterHashPasswordFilter() {
    }

    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("RegisterHashPasswordFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("RegisterHashPasswordFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("RegisterHashPasswordFilter:doFilter()");
        }
...
//            request.getRequestDispatcher("view/auth/register.jsp").forward(request, response);
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("RegisterHashPasswordFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("RegisterHashPasswordFilter()");
        }
        StringBuffer sb = new StringBuffer("RegisterHashPasswordFilter(");
